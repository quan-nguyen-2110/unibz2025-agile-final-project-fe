...
import { BookingFilterSection, BookingFilterState } from "@/components/BookingFilterSection";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
  ...
  const handleFilterChange = (filters: BookingFilterState) => {
    ...
    if (filters.apartmentName.trim()) {
      filtered = filtered.filter(booking => 
        booking.apartmentTitle.toLowerCase().includes(filters.apartmentName.toLowerCase())
      );
    }
  ...
  const handleCancelBooking = () => {
    ...
    const updatedBookings = bookings.map(booking =>
      booking.id === selectedBookingId 
        ? { ...booking, status: 'cancelled' as const, cancelReason: cancelReason.trim() } 
        : booking
    );
    setBookings(updatedBookings);
    setFilteredBookings(updatedBookings);
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Manage all apartment bookings from users</p>
        </div>
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-muted-foreground">
                {bookings.length === 0 ? "No users have made bookings yet." : "No bookings match your filters."}
              </p>
            </CardContent>
          </Card>
        ) : (
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    Please provide a reason for cancelling this booking. The user will see this comment.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <div className="py-4">
